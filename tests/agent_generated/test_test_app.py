...
# Rewritten import target: solution → tests.agent_generated.test_app
import pytest
from unittest.mock import MagicMock, patch
from flask import Flask
from tests.agent_generated.test_app import create_app, lookup_user, main
...
def test_lookup_user():
    ...
    mock_cursor.execute.assert_called_with("SELECT * FROM users WHERE username = %s", ('nonexistentuser',))
    assert result == []
