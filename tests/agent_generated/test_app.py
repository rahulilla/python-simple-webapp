...
def test_lookup_user():
    ...
    with patch.object(mock_db_conn, 'cursor', return_value=MagicMock(__enter__=MagicMock(), __exit__=MagicMock())) as mock_cursor_manager:
        mock_cursor = mock_cursor_manager.return_value.__enter__.return_value
